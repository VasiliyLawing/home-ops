...
let
  ...
  sabnzbdSeedSecrets = pkgs.writeShellScript "home-ops-sabnzbd-seed-secrets" ''
    ...
    "$sed" -i "/^\[misc\]/a api_key = $(< "$secrets/sabnzbd-api-key")" "$ini"
    if [ -r "$secrets/sabnzbd-usenet-username" ] && [ -r "$secrets/sabnzbd-usenet-password" ]; then
      ...
      "$sed" -i "/\[\[news\.newsgroup\.ninja\]\]/a username = $(< "$secrets/sabnzbd-usenet-username")\npassword = $(< "$secrets/sabnzbd-usenet-password")" "$ini"
    else
