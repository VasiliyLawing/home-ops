...
in
{
  ...
  services = {
    ...
    caddy.email = "vblawing@gmail.com";
    # Token is operator-provisioned on the box, not autogenerated:
    #   echo "<duckdns-token>" > /var/lib/home-ops/secrets/duckdns-token
    #   chmod 600 /var/lib/home-ops/secrets/duckdns-token
    duckdns = {
      enable = true;
      domains = [
        "lawing"
