{
  ...
  homeOps = {
    ...
    ingress = {
      ...
      requestsHost = "requests.lawing.net";
    };
  };
  ...
  # A records for media/requests/auth.lawing.net must already exist in
  # Cloudflare — this service only UPDATES existing records to the current IP.
