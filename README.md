...
|-- movies / TV services
|-- sports event PVR (Sportarr) + live TV (EPlusTV)
...
creates Jellyfin Movies/TV/Sports libraries, seeds Jellyfin's VAAPI hardware
...
directly on the host. Wizarr issues
